...
\item {
            \textbf{Tecnologías}{: AWS, Android, React, Astro, Jetpack Compose, Flutter, PostgreSQL, MySQL, Firebase, Git, Docker, Kubernetes, Espresso, Mockito, JUnit, Test-Driven Development, Clean Architecture, SOLID, Design Patterns, RESTful APIs, Microservices, CI/CD, Agile, Scrum, Maven, Gradle, Jira}
      }
\resumeSubHeadingListEnd
