...
\resumeSubHeadingListStart
\resumeSubItem{Udemy - React: De cero a experto - Edición 2025}{Ene 2026 (estimado)}
...
\resumeSubHeadingListStart
\item{
            \textbf{Lenguajes}{: TypeScript, JavaScript, HTML, CSS, SQL, Python}

      }
\item {
            \textbf{Tecnologías}{: AWS, Astro, Tailwind CSS, Cloudflare Edge Functions, Google Web Toolkit (GWT), PostgreSQL, MySQL, Firebase, Git, GitHub Actions, Test-Driven Development, Clean Architecture, SOLID, Design Patterns, RESTful APIs, Microservices, CI/CD, Agile, Scrum, Jira}
      }
\resumeSubHeadingListEnd
